...
// Ignoring this for Coding standards as Silencing errors is discouraged
// Generic.PHP.NoSilencedErrors.Discouraged
if (@constant('UPDRAFTCENTRAL_DEBUG_LEVEL')) {
	$uc_debug_level = UPDRAFTCENTRAL_DEBUG_LEVEL;
} elseif (@constant('UPDRAFTCENTRAL_DEV_ENVIRONMENT')) {
	$uc_debug_level = 1;
}
...
return array(
	...
	'add_site' => __('Add Site', 'updraftcentral'),
	...
	'go_here_for_help_including_screenshots' => __('Follow this link for help, including a video and screenshots', 'updraftcentral'),
	'go_here_for_connection_help' => __('Go here for help in trouble-shooting connection issues', 'updraftcentral'),
	'http_authentication_if_any' => __('HTTP authentication (for sites protected by a password)', 'updraftcentral'),
	'http_authentication_method' => __('Authentication method'),
	'http_username' => __('HTTP username', 'updraftcentral'),
	'http_password' => __('HTTP password', 'updraftcentral'),
