<div id="updraftcentral_modal_dialog" class="modal fade" tabindex="-1" role="dialog">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-sm btn-primary updraft_modal_button_goahead">Go</button>
				<button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal"><?php _e('Close', 'updraftcentral');?></button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
