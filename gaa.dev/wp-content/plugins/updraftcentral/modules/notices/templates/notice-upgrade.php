...
<div id="updraftcentral_panel_notices" class="updraftcentral-show-in-tab-notices updraftcentral-hide-in-other-tabs">
	...
	<p> 
		<?php _e('UpdraftCentral Premium has an added, handy User Management module, and more to come in future. Our UpdraftCentral Cloud version has this too, plus the additional convenience of having it completely hosted on UpdraftPlus.com, maintained and personally supported by our team (i.e. "Software as a Service, SaaS").', 'updraftcentral');?>
	</p>
	...
	<table class="updraftcentral_comparison">
		...
		<tr>
			<td></td>
			<td>
				<img src="<?php echo UD_CENTRAL_URL.'/images/updraft_central_logo.png';?>" alt="<?php esc_attr_e('UpdraftCentral', 'updraftcentral');?>" width="150" height="150">
			</td>
			<td>
